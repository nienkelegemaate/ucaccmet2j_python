...
# ---part 2---
yearly_precipitation = sum(total_monthly_precipitation)
relative_precipitation_month = [round((x/yearly_precipitation), ndigits = 2) for x in total_monthly_precipitation]
